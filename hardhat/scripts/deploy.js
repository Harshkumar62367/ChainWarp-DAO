...
async function main() {
  ...
  const amount = hre.ethers.parseEther("0.01"); // You can change this value from 1 MATIC to something else
  ...
  // Sleep for 30 seconds to let MMUMBAISCAN catch up with the deployments
  await sleep(30 * 1000);
